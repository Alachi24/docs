---
title: "How do I generate a session id?"
description: ""
---

As outlined in the [getting started guide](https://developer.themoviedb.org/docs/getting-started), the basics to getting a user authenticated look like this:
